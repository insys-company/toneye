...
import { MINMAX_PANEL_DATA, AppMinmaxOverlayComponent } from './app-minmax-overlay/app-minmax-overlay.component';
...
export class AppMinmaxService {
    /**
     * Экземпляр объекта для создания портейла с
     * шаблоном  AppPaginatorOverlayComponent
     * @type {componentPortal}
     */
    private componentPortal: ComponentPortal<AppMinmaxOverlayComponent>;
    /**
     * Объект для overlay
     * @type {OverlayRef}
     */
    ...
    createInjector(data: any): PortalInjector {
        ...
        injectorTokens.set(MINMAX_PANEL_DATA, data);
